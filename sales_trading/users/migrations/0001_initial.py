    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('seller', 'Seller'), ('trader', 'Trader'), ('customer', 'Customer')], db_index=True, default='customer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='profile_pics/')),
                ('stores', models.ManyToManyField(related_name='traders', to='products.store')),
